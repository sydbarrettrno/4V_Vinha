...
import logo from "@/assets/logo-4v.png";
const Header = () => {
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center">
            <img alt="4V Vinha LTDA" className="h-16 w-auto" src="/logo-4v-vinha-main.png" />
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Button onClick={() => window.open("https://wa.me/5511999999999", "_blank")} className="bg-primary hover:bg-primary/90">
              Fale Conosco
            </Button>
          </nav>
        ...
        {isMobileMenuOpen && <nav className="md:hidden py-4 border-t border-border">
            <div className="flex flex-col space-y-4">
              ...
              <Button onClick={() => window.open("https://wa.me/5511999999999", "_blank")} className="bg-primary hover:bg-primary/90 w-full">
                Fale Conosco
              </Button>
            </div>
          </nav>}
